...
<li class="menu-item-has-children dropdown">
 ...
 <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-file-o"></i><a href="manage_users.php">Manage Users</a></li>
                             <li><i class="menu-icon fa fa-file-o"></i><a href="manage_oldusers.php">View Old Users</a></li>
                            <li><i class="menu-icon fa fa-file-o"></i><a href="view_allusers.php">All Users</a></li>
...
<li class="active">
  ...
  <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><a href="view_payments.php"><i class="fa fa-money"></i> View Payments</a></li>
